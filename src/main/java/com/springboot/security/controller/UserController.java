...
import com.springboot.security.common.UserConstants;
...
public class UserController {
    ...
    //if loggedin user is MODERATOR
    //Principal always give the logged-in user name
    ...
    public String giveAccessToUser(@PathVariable int userId, @PathVariable String userRole, Principal principal) {
        ...
        userRepository.save(user);
        return "Hi "+user.getUserName()+" Access has been granted by "+principal.getName();
    }
